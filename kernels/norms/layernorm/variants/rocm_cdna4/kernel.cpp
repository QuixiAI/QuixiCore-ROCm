...
constexpr unsigned long long DROPOUT_SEED = 42ULL;

#ifndef LAYER_NORM_DROPOUT_P
#define LAYER_NORM_DROPOUT_P 0.0
#endif

constexpr float DROPOUT_P = static_cast<float>(LAYER_NORM_DROPOUT_P);
...
__device__ void dropout_mask(T &dst, float keep_prob) {
    ...
    rocrand_init(DROPOUT_SEED, idx, 0, &state);
