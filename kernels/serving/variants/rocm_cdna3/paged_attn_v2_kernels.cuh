...
#include <hip/hip_bf16.h>   // __hip_bfloat16 (hip_fp16.h does not pull it in, unlike cuda_fp16.h)
#include <cstdint>
#include <cstdio>
#include <cstdlib>
#include <vector>
...
template __global__ void paged_attention_reduce<__hip_bfloat16, 512>(
    const float*, const float*, const float*, __hip_bfloat16*, int, int);
