 ...
 * T in {float, __half, __hip_bfloat16}.
 *
...
template <> __device__ __forceinline__ float tf<__hip_bfloat16>(__hip_bfloat16 v)   { return __bfloat162float(v); }
...
template <> __device__ __forceinline__ __hip_bfloat16  ft<__hip_bfloat16>(float v)  { return __float2bfloat16(v); }
