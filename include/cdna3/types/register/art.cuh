 ...
 */
 ...
 struct art {
    ...
    using row_vec = rv<T, cols, typename art_base<T, layout, shape, ducks::art::get_nth_range_t<register_ranges, 0>>::row_vec_layout>; ///< A type representing a row vector for this tile.
    using col_vec = rv<T, rows, typename art_base<T, layout, shape, ducks::art::get_nth_range_t<register_ranges, 0>>::col_vec_layout>; ///< A type representing a column vector for this tile.
 };
