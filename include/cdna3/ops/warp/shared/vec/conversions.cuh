 ...
 *
 * @tparam SV1 The type of the destination shared vector, must satisfy the typename concept, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<concept>>::value, int> = 0.
 * @tparam SV2 The type of the source shared vector, must satisfy the typename concept, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<concept>>::value, int> = 0.
 ...
 */
template<typename SV1, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<SV1>>::value, int> = 0, typename SV2, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<SV2>>::value, int> = 0>
...
* @tparam SV The type of the input vector, which must satisfy the typename concept, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<concept>>::value, int> = 0.
...
*/
template<int subvec_length, typename SV, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<SV>>::value, int> = 0>
