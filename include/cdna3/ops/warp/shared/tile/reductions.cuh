 ...
 */
template<typename op, typename V, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<V>>::value, int> = 0, typename T, std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<T>>::value, int> = 0, bool reset>
 ...
 */
template<typename V, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<V>>::value, int> = 0, typename T, std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<T>>::value, int> = 0>
