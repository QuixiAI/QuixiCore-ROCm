 ...
 */
template<typename op, typename T, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
 ...
 // --- exp shortcuts ---
 template<typename T, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
template<typename op, typename T, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<T>>::value && (std::is_same_v<typename std::remove_cvref_t<T>::layout, kittens::ducks::rv_layout::align> || std::is_same_v<typename std::remove_cvref_t<T>::layout, kittens::ducks::rv_layout::ortho>), int> = 0>
 ...
 */
template<typename T, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<T>>::value, int> = 0, typename U>
