 ...
 */
template<typename op, typename T, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
template<typename op, typename T, typename V, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value && std::is_same_v<typename std::remove_cvref_t<T>::layout, kittens::ducks::rt_layout::row> && kittens::detail::is_rv<std::remove_cvref_t<V>>::value, int> = 0>
 ...
 * @param row_values[in] Column vector containing values to apply across each row.
 */
template<typename op, typename T, typename V, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value && std::is_same_v<typename std::remove_cvref_t<T>::layout, kittens::ducks::rt_layout::col> && kittens::detail::is_rv<std::remove_cvref_t<V>>::value, int> = 0>
__device__ static inline void row_map(T &dst, const T &src, const V &row_values) {
 ...
 * @param dst[out] Destination tile where the result is stored.
 */
template<typename T, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
template<typename T, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value, int> = 0, typename U>
 ...
 */
template<typename T, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<T>>::value, int> = 0, typename V, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<V>>::value, int> = 0>
