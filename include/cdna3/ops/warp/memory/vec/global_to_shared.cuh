 ...
 */
template<typename SV, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<SV>>::value, int> = 0, kittens::ducks::gl::all GL, kittens::ducks::coord::vec COORD=coord<SV>>
