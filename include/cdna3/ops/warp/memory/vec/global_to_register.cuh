 ...
 */
template<typename RV, std::enable_if_t<kittens::detail::is_rv<std::remove_cvref_t<RV>>::value, int> = 0, kittens::ducks::gl::all GL, kittens::ducks::coord::vec COORD=coord<RV>>
