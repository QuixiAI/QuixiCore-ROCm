...
template< int  axis, bool assume_aligned,
          typename ST, kittens::ducks::gl::all GL,
          kittens::ducks::coord::tile COORD = coord<ST>,
 ...
 */
template<int N_THREADS = WARP_THREADS, typename ST,
         std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<ST>>::value, int> = 0>
 ...
 */
template<int axis, bool assume_aligned, typename ST, kittens::ducks::gl::all GL, kittens::ducks::coord::tile COORD=coord<ST>, int N_THREADS=WARP_THREADS,
         std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<ST>>::value, int> = 0>
