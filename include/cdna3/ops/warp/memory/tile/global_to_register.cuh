 ...
 */
template<int axis, typename RT, kittens::ducks::gl::all GL, kittens::ducks::coord::tile COORD=coord<RT>,
         std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<RT>>::value && std::is_same_v<typename std::remove_cvref_t<RT>::layout, kittens::ducks::rt_layout::row>, int> = 0>
 ...
 */
template<int axis, typename RT, kittens::ducks::gl::all GL, kittens::ducks::coord::tile COORD=coord<RT>,
         std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<RT>>::value && std::is_same_v<typename std::remove_cvref_t<RT>::layout, kittens::ducks::rt_layout::col>, int> = 0>
__device__ inline static void load(RT &dst, const GL &src, const COORD &idx) {
...
template<typename RT, kittens::ducks::gl::all GL, kittens::ducks::coord::tile COORD=coord<RT>,
         std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<RT>>::value, int> = 0>
__device__ inline static void load(RT &dst, const GL &src, const COORD &idx) {
