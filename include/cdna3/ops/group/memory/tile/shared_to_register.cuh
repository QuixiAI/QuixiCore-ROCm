 ...
 */
template<typename RT, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<RT>>::value, int> = 0, typename ST, std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<ST>>::value, int> = 0>
__device__ inline static void load(RT &dst, const ST &src) {
    ...
    if constexpr (std::is_same_v<typename RT::layout, kittens::ducks::rt_layout::row>) {
    ...
    for (int i = 0; i < dst.height; i++) {
        ...
        for (int j = 0; j < dst.width; j++) {
            ...
            if constexpr (std::is_same_v<typename RT::layout, kittens::ducks::rt_layout::row>) { // handle the row-major layout
 ...
 */
template<typename ST, std::enable_if_t<kittens::detail::is_st<std::remove_cvref_t<ST>>::value, int> = 0, typename RT, std::enable_if_t<kittens::detail::is_rt<std::remove_cvref_t<RT>>::value, int> = 0>
