 ...
 */
template<typename op, typename T, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
template<typename T, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<T>>::value, int> = 0>
 ...
 */
template<typename T, std::enable_if_t<kittens::detail::is_sv<std::remove_cvref_t<T>>::value, int> = 0, typename U>
