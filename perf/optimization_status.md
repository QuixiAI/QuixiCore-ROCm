...
## 2026-07-06: CUDA Kernel Surface To CDNA3 Inventory — DEFERRED
...
## 2026-07-06: Elementwise/Norm Family CDNA3 Port + Wavefront-Width A/B — KEPT
...
## 2026-07-06: Quant Dequant + GEMV Family CDNA3 Port — KEPT
...
## 2026-07-06: Serving Family CDNA3 Port — LANDED
...
## 2026-07-06: MoE Family CDNA3 Port — KEPT
...
## 2026-07-06: Quant Tensor-Core GEMM CDNA3 MFMA Rewrite — LANDED
...
## 2026-07-06: Quant/MoE Tensor-Core Tail (MFMA + plain) — KEPT
...
## 2026-07-06: ThunderKittens Compute Tier — GQA Attention CDNA3 Finding — UNLABELED
...
## 2026-07-06: Linear-Attention (TM) + Mamba2 Selective-Scan CDNA3 Ports — LANDED
...
## 2026-07-06: pyext Harness Unblock (LD_PRELOAD) + Attention Re-confirmation — UNLABELED
...
## 2026-07-06: flux + Based CDNA3 Ports — KEPT
...
## 2026-07-06: ThunderKittens Compute Tier COMPLETE (hedgehog, decay-linattn, fftconv, mamba2 SSD) — LANDED
...
## 2026-07-07: Metal Gap Kernel Ports To CDNA3 — KEPT
...
## 2026-07-22: embeddinggemma.c ROCm Kernel Ports To CDNA3 — KEPT
...
## 2026-07-25: Metal/CPU Parity Program — Phase 0 Harness Infrastructure — KEPT
...
## 2026-07-25: cross_attention (Metal/CPU parity Phase 1) — KEPT
...
## 2026-07-25: biased_attention (Metal/CPU parity Phase 1) — KEPT
...
## 2026-07-25: rope_variants — 8 RoPE operations (Metal/CPU parity Phase 1) — MIXED
...
## 2026-07-25: attn_composites — swin / decode-cache / cascade (Phase 1 complete) — KEPT
...
## 2026-07-25: kv_cache_q8_0 — Q8_0 paged KV codec (Phase 2, 4/17) — KEPT
...
## 2026-07-26: matmul-decode_epilogues Phase 3 CPU/Metal parity — MIXED
...
## 2026-07-26: matmul-decode_epilogues packed Phase 3 completion — KEPT
...
## 2026-07-26: MoE Phase 4 CPU/Metal parity completion — KEPT
...
## 2026-07-26: BaseQ Phase 5 Canonical Family — KEPT
...
## 2026-08-01: serving `v2_batch_prep` (V2 model-runner batch prep) — MIXED
...
## 2026-08-01: serving `v2_sample` (V2 sampler / spec-decode) — KEPT
...
## 2026-08-01: serving `sparse_indexer` (ROCm sparse-MLA indexer) — KEPT
...
## 2026-08-01: serving `fp8_mqa_logits` (DSA indexer MQA logits, fp8 MFMA) — UNLABELED
...
## 2026-08-02: quantization `mxfp4_gguf` (OCP MXFP4 in the GGUF layout) — UNLABELED
